...
################################ Various plots ################################
def AV_plot_line_ConfInt(axe_p, x_p, y_p, yerr_p, label_p=None, color_p="b", linewidth_p=5, linestyle_p="-", marker_p=None, alpha_p=0.2):
	"""
	yerr_p should be positive.
	"""

	axe_p.plot(x_p, y_p, color=color_p, linewidth=linewidth_p, linestyle=linestyle_p, marker=marker_p, label=label_p)

...
################################ Various plots ################################
def AV_plot_line_errorbar(axe_p, x_p, y_p, yerr_p, xerr_p, color_p="b", label_p=None, capsize_p=5, linewidth_p=5):

	axe_p.errorbar(x=x_p, y=y_p, yerr=yerr_p, capsize=capsize_p, mfc=color_p, label=label_p, linewidth=linewidth_p)
